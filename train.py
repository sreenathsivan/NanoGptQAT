...
if init_from == 'scratch':
    ...
    for _, mod in model.named_modules():
        ...
        if isinstance(mod, torch.nn.Embedding):
            ...
            mod.qconfig = torch.quantization.get_default_qat_qconfig('fbgemm')
    qmodel = torch.quantization.prepare_qat(model, inplace=True)
    ...
    if iter_num % eval_interval == 0 and master_process:
        ...
        if losses['val'] < best_val_loss or always_save_checkpoint:
            ...
            if iter_num > 0:
                ...
                optimizer = quantized_model.configure_optimizers(weight_decay, learning_rate, (beta1, beta2), device_type)
                qcheckpoint = {
                ...
                torch.save(qcheckpoint, os.path.join(out_dir, 'qckpt.pt'))
